...
const TEXTS = [
  ...
  { s: 'bn', x: 160, y: 1884, t: 'topology：identity / response_reuse / loaded_runtime_cache / model_execution / provider_adapter 僅預留；未實作、不新增 executable Python module、public symbol 或 re-export' }
];
