...
| Field | Contract |
| --- | --- |
| In-Scope | Historical delivery: five concrete stages, two default-builder factories, the cycle-safe private snapshot adjustment, exports, dedicated tests, a delivered Archify dataflow diagram, and publish-time README/version promotion. Completed CSO1 C3 adds only nominal Protocol inheritance and `@override` markers in the five concrete stages plus their direct regression assertions. C7S is completed frozen status provenance; PRCF1 adds exact-string/surrogate/snapshot-type corrections, dedicated regressions, and bounded nine-thread classification/reply routing. P8–P10 recovery is completed immutable provenance; the final-state reconciliation is planning-only and corrects routing state without changing code, tests, `uv.lock`, or PR threads. |
...
- **Current routing state**: `pr-comment-review-and-fix-p8-p10-final-state-reconciliation-review-pending`.
  The recovery Plan-Reviewer receipt `b903cb06c2e174501228aab1325179fc1e13bc08`, the subsequent
  Planner P8 Phase 4.5 alignment, and the fresh P9/P10 one-path classification-evidence commit
  `8a86e88621e00bbc10e773411cb10c6272b6fc45` are completed immutable facts. The historical
  `18d9b4751df26376c9cf47fe7968130870f07fe7` record is superseded immutable nonrouting
  provenance. P11 is pending; it has no authority in this planning candidate.
- **Pre-reconciliation snapshot (frozen narrative only)**: CSO1 C0/C1/C2,
  ...
  The then-active P8–P10 route-recovery candidate awaited its receipt. This frozen narrative is
  superseded by the current routing state above. Draft PR #6 remains open and CAVO1 is completed
  historical provenance.
- **Pre-reconciliation execution narrative (frozen only)**: CSO1 C0 → approved C1 log → sole-evidence C2 commit → rejected C0S →
...
| PRCF1 historical pre-P8 classification | `plan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix.thread-classification.json` | Independent Reviewer | Superseded immutable nonrouting provenance at `18d9b4751df26376c9cf47fe7968130870f07fe7`; it cannot route P10 or replies. |
| PRCF1 P8–P10 route-recovery correction plan | `plan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p8-p10-route-recovery.correction-plan.md` | Plan-Creator | Completed frozen ten-path recovery admission. |
| PRCF1 P8–P10 route-recovery correction step | `plan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p8-p10-route-recovery.correction-step.md` | Plan-Creator | Completed frozen recovery tracking. |
| PRCF1 P8–P10 route-recovery Plan-Reviewer log | `plan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p8-p10-route-recovery.correction-plan-review-log.json` | Independent Plan-Reviewer | Completed approved recovery receipt committed at `b903cb06c2e174501228aab1325179fc1e13bc08`. |
| PRCF1 fresh P9/P10 classification evidence | `plan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p8-p10-route-recovery.thread-classification.json` | Independent Reviewer; Independent Implementer | Fresh P9 content committed unchanged as sole P10 evidence at `8a86e88621e00bbc10e773411cb10c6272b6fc45`. |
| PRCF1 P8–P10 final-state reconciliation correction plan | `plan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p8-p10-final-state-reconciliation.correction-plan.md` | Plan-Creator | Exact eight-path final-state reconciliation and sole conditional receipt contract. |
| PRCF1 P8–P10 final-state reconciliation correction step | `plan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p8-p10-final-state-reconciliation.correction-step.md` | Plan-Creator | Final-state tracking; P11 remains pending. |
| PRCF1 P8–P10 final-state reconciliation Plan-Reviewer log | `plan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p8-p10-final-state-reconciliation.correction-plan-review-log.json` | Independent Plan-Reviewer | Sole conditional receipt, written only from this clean committed eight-path candidate and separately committed unchanged if approved. |
...
4. P7 receipt-status-sync completed at `49c0bcd197c6b9ac4fb1baba115c903060ff52cf`; recovery
   receipt `b903cb06c2e174501228aab1325179fc1e13bc08`, Planner P8, and fresh P9/P10 commit
   `8a86e88621e00bbc10e773411cb10c6272b6fc45` are immutable completed facts. The structurally
   correct `18d9b4751df26376c9cf47fe7968130870f07fe7` classification is superseded immutable
   nonrouting provenance. Seven are resolvable only when the fresh P9/P10 evidence proves their
   correction; the two `uv.lock` threads remain
