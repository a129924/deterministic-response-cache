...
# PRCF1 P7 status-alignment receipt status-sync correction plan
...
commit `ff19d0aeda3305e6bc743930827408122d18a55a`, plus P6/P7 review evidence commit
`24ef18b835b7646e05bf0fc3f5828349eea52b1d`, are complete frozen facts. P7 status-sync candidate
`850c1e66f2d2dc339620ca86e03660f1faef9331` remains rejected immutable nonrouting provenance;
its uncommitted outcome is not a receipt and cannot be reused.
...
`40824056def6c9d3402e95039af6a931b67ee547` and change exactly these eight planning paths:
...
A\tplan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p7-status-alignment-receipt-status-sync.correction-plan.md
A\tplan/canonical-identity-pipeline/canonical-identity-pipeline.pr-comment-review-and-fix-p7-status-alignment-receipt-status-sync.correction-step.md
```
...
```json
{
  "schema_version": "canonical-identity-pipeline.pr-comment-review-and-fix-p7-status-alignment-receipt-status-sync.correction-plan-review.v1",
  "topic": "canonical-identity-pipeline",
  "correction_id": "canonical-identity-pipeline/pr-comment-review-and-fix-p7-status-alignment-receipt-status-sync",
  "candidate_commit": "<40-hex receipt-status-sync candidate>",
  "candidate_tree": "<40-hex receipt-status-sync candidate tree>",
  "reviewed_paths": [
  ...
  "first_parent_admission": {
    ...
    "parent_commit": "40824056def6c9d3402e95039af6a931b67ee547",
    "non_merge": true,
    "first_parent": "40824056def6c9d3402e95039af6a931b67ee547",
  ...
  "review_basis": "clean committed eight-path P7 status-alignment receipt status-sync tree; committed P7 repair candidate and approved receipt facts; rejected 850 status-sync provenance and no receipt reuse; P8 pending and Planner-only; unchanged PRCF1 scope and nine-thread triage",
