...
provenance. Its uncommitted Plan-Reviewer outcome is not a receipt and is neither committed,
  ...
  status-sync route records those facts. P8 Phase 4.5 remains pending and Planner-only; P9–P11
  have not started. No alignment result, classification, reply, resolution, push, PR, approval,
