...
- [ ] Independent Implementer: commit exactly seven B4R6 baseline paths as non-subject; report named
  `b900366..<B4R6-SHA>` diff.
- [ ] Independent Plan-Reviewer: from clean B4R6 checkout, review seven committed blobs and write
  only B4R6 review evidence using the locked seven-blob schema.
